...
const Header = () => {
    return (
        <Navbar sticky='top' className='navbar' style={{ 'padding': '0px' }} collapseOnSelect expand="lg" variant="dark">
            <Container>
                <Navbar.Brand  href="home#home"><img className='rounded' src={logo} alt="" /></Navbar.Brand>
                <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="me-auto">
                        <Nav.Link className='navber-items' style={{ 'color': 'lightcyan' }} href="#product">Product</Nav.Link>
